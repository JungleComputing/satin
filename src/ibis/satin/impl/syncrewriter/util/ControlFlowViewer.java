...
class ControlFlowViewer {
    ...
    void print(PrintStream out, int level, String string, Object... arguments) {
        ...
        if (completeMessage.length() > NR_CHARS_ON_LINE) {
            ...
            print(out, level + 1, completeMessage.substring(NR_CHARS_ON_LINE, completeMessage.length()));
        } else {
    ...
    boolean jumpInstruction(InstructionContext currentContext, InstructionContext nextContext, InstructionContext[] successors) {
