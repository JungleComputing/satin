...
public interface Analyzer {
     ...
     * @param debug  An instance of a debug utility for printing error, warning and
     *               debug messages.
     *
     * @return The instructionhandles before which the syncrewriter should insert
     *         sync statements.
     * @throws SyncInsertionProposalFailure When the analysis fails.
     */
    public InstructionHandle[] proposeSyncInsertion(SpawningMethod method, Debug debug) throws SyncInsertionProposalFailure;
