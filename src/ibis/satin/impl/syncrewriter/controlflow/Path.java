...
public class Path extends ArrayList<BasicBlock> {
     ...
     * get(index), but the index of the basic block in the method. The last basic
     * block will be the basic block with index indexBasicBlock.
     *
     * @param idBasicBlock the id of the basic block.
     *
     * @return a path from the first basic block until and including the basic block
     *         which has an id equal to idBasicBlock.
     */
