...
public class EarliestLoad implements Analyzer {
    ...
    @Override
    public InstructionHandle[] proposeSyncInsertion(SpawningMethod spawnableMethod, Debug debug) throws SyncInsertionProposalFailure {
        ...
        instructionHandles[0] = getEarliestLoadInstruction(instructionList, spawnableCalls);
     ...
     */
    private InstructionHandle getEarliestLoadInstruction(InstructionList il, ArrayList<SpawnableCall> spawnableCalls)
        ...
        for (SpawnableCall spawnableCall : spawnableCalls) {
            InstructionHandle loadInstruction = getLoadInstruction(il, spawnableCall);
     ...
     */
    private InstructionHandle getLoadInstruction(InstructionList il, SpawnableCall spawnableCall) throws SyncInsertionProposalFailure {
