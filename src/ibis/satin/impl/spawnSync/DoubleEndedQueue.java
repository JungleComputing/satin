...
public final class DoubleEndedQueue implements Config {
        ...
        while (curr != null) {
            ...
            if ((curr.getParent() != null && curr.getParent().aborted) || curr.isDescendentOf(targetStamp)) {
                ...
                if (abortLogger.isDebugEnabled()) {
                    abortLogger.debug("found local child: " + curr.getStamp() + ", it depends on " + targetStamp);
                }
    ...
    /**
     * Used for fault-tolerance Aborts all the descendents of any job stolen for the
     * given (crashed) processor
     *
     * @param owner IbisIdentifier of the processor whose jobs (and their
    ...
    public void killSubtreeOf(ibis.ipl.IbisIdentifier owner) {
        ...
        while (curr != null) {
            ...
            if ((curr.getParent() != null && curr.getParent().aborted) || curr.isDescendentOf(owner) || curr.getOwner().equals(owner)) {
                // shouldn't happen
                curr.decrSpawnCounter();
