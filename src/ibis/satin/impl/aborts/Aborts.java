...
public final class Aborts implements Config {
    ...
    public void handleInlet(InvocationRecord r) {
        ...
        try {
            if (inletLogger.isDebugEnabled()) {
                inletLogger.debug("SATIN '" + s.ident + ": calling inlet caused by remote exception");
            }
            ...
            if (inletLogger.isDebugEnabled()) {
                inletLogger.debug("Got an exception from exception handler! " + t + ", r = " + r + ", r.parent = " + r.getParent(), t);
            }
            ...
            if (!r.getParentOwner().equals(s.ident)) {
                if (inletLogger.isDebugEnabled()) {
                    inletLogger.debug("SATIN '" + s.ident + ": sending exception result");
                }
    ...
    private void handleEmptyInlet(InvocationRecord r) {
        ...
        if (inletLogger.isDebugEnabled()) {
            inletLogger.debug("SATIN '" + s.ident + ": Got exception, empty inlet: " + r.eek, r.eek);
        }
    ...
    private void handleExceptions() {
        ...
        while (true) {
            ...
            if (inletLogger.isDebugEnabled()) {
                inletLogger.debug("SATIN '" + s.ident + ": handling remote exception: " + r.eek + ", inv = " + r);
            }
            ...
            if (inletLogger.isDebugEnabled()) {
                inletLogger.debug("SATIN '" + s.ident + ": handling remote exception DONE");
            }
        }
    }
    ...
    private void handleAborts() {
        ...
        while (true) {
            ...
            if (abortLogger.isDebugEnabled()) {
                abortLogger.debug("SATIN '" + s.ident + ": handling abort message: stamp = " + stamp);
            }
            ...
            if (abortLogger.isDebugEnabled()) {
                abortLogger.debug("SATIN '" + s.ident + ": handling abort message: stamp = " + stamp + " DONE");
            }
        }
    }
