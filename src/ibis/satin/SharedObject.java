...
public class SharedObject implements java.io.Serializable {
    ...
    /**
     * Returns true if the shared object is still local. Write operations that are
     * done while the object is still local are not broadcasted. As soon as an
     * invocation record is made with this object, or exportObject is called, the
     * object is considered non-local.
     *
    ...
    /**
     * This method is optional, and can be used after creating a shared object. It
     * allows Satin to immediately distribute a replica to all machines
     * participating in the application. This way, machines won't have to ask for it
     * later.
     */
    public void exportObject() {
        ...
        if (!isUnshared) {
            throw new RuntimeException("write method invoked before exportObject");
        }
