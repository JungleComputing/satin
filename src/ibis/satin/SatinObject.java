...
public class SatinObject implements java.io.Serializable {
    ...
    /**
     * Recursively aborts all methods that were spawned by the current method and
     * all methods spawned by the aborted methods.
     */
    public void abort() {
        /* do nothing, bytecode is rewritten to handle this */
    }
    ...
    /**
     * Pauses Satin operation. This method can optionally be called before a large
    ...
    /**
     * Resumes Satin operation. This method can optionally be called after a large
     ...
     * enough work in the system to keep all processors busy, this method returns
     * false.
     *
     * @return <code>true</code> if it might be useful to spawn more invocations,
     *         false if there is enough work in the system.
     */
